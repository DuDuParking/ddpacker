...
public class Pgwxpay extends CordovaPlugin  {
	...
	public static Pgwxpay wxpay = null;
  ...
  private String lastErr = "";
	...
	public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) {
		...
		if (action.equals("iswx")) {
			final IWXAPI msgApi = WXAPIFactory.createWXAPI(cordova.getActivity(), null);
			String iswx = msgApi.isWXAppInstalled()?"1":"0";
			callbackContext.success(iswx); 
				return true;
		 }else if (action.equals("wxpay2")) {
		 		JSONObject cityad = args.optJSONObject(0);
	      String appid = cityad.optString("appid");
	      String prepayid = cityad.optString("prepayid");
				...
				req = new PayReq();
				req.appId = appid;
				req.partnerId = cityad.optString("partnerid");
				req.prepayId = prepayid;
				req.packageValue = cityad.optString("package");
				req.nonceStr = cityad.optString("noncestr");
				req.timeStamp = cityad.optString("timestamp"); 
...
//	           String url = "http://dev.breadth.com.cn/zhifu/alipay/notify_url.php";
	           ...
	           Runnable payRunnable = new Runnable() {
					...
					public void run() {   
						...
						Log.e("Pgwxpay.signParams", signParams.toString()); 
		 	...
		 	}else if (action.equals("getcode")) { // 获取返回的支付结果
				callbackContext.success(lastErr); 
				return true;    
...
private String genPackageSign(List<NameValuePair> params) {
	...
	Log.e("Pgwxpay.packageSign",packageSign);
	return packageSign;
}
...
private String toXml(List<NameValuePair> params) {
	...
	Log.e("Pgwxpay.toXml",sb.toString());
	try {  
...
private String genAppSign(List<NameValuePair> params) {
	...
	protected Map<String,String> doInBackground(String entity1) {
		...
		Log.e("Pgwxpay.doInBackground.entity",entity);

		byte[] buf = Util.httpPost(url, entity);

		String content = new String(buf);
		Log.e("Pgwxpay.doInBackground.content", content);
	...
	public Map<String,String> decodeXml(String content) {
		...
		try {
			...
			Log.e("Pgwxpay.decodeXml",e.toString());
		}
		return null;
