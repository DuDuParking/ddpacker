...
//	           String url = "http://dev.breadth.com.cn/zhifu/alipay/notify_url.php";
	           ...
	           Runnable payRunnable = new Runnable() {
				...
				SharedPreferences settings = cordova.getActivity().getSharedPreferences("wxcode", 0);			
				String code =settings.getString("code", ""); 
				Log.d("返回内容code", "返回内容code=" + code);
				
				SharedPreferences mySharedPreferences= cordova.getActivity().getSharedPreferences("wxcode",0); 
